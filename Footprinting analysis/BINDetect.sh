...
################################# REQUIREMENTS ################################
#
# Specify the path to INPUT_SCORES. If you have previously run ScoreBigwig.sh,
# the path to footprint scores files should be the same as specified here.
#
# The input BED files with peaks should be annotated to determine the target
# genes associated to each TFBS.
#
